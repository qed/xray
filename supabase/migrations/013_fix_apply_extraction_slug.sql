-- Migration 013: Fix apply_extraction to generate slugs inline
-- The slug column on priorities was made NOT NULL in migration 011,
-- but apply_extraction (created in 009) inserts without slugs.
-- This replaces the function to generate slugs at insert time.
